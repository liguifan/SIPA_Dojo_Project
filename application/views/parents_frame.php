...
<div id="wrapper">
  <div class="navbar" id="navHeader">
    <div class="navbar-inner">
      <div class="container">
          <a href="<?php echo my_base_URL(); ?>parents" id="logo"></a> 
        <span id="navLinks">
            <a href="<?php echo my_base_URL();?>parents" class="btn btn-default">Home</a>
            <?php if($Parent['DirParent']) { ?>
            <a href="<?php echo my_base_URL();?>parents/obs" class="btn btn-default">Observers</a>
            <?php } ?>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="<?php echo my_base_URL();?>parents/profile">Edit Profile</a></li>
                <li><a href="<?php echo my_base_URL();?>parents/chgpwd">Change Password</a></li>
                <li><a href="<?php echo my_base_URL();?>parents/logout">Logout</a></li>
              </ul>
            </div>
        </span>
      </div>
